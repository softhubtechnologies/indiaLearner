...
class SubtestModel {
  SubtestModel({
    String statusCode,
    String message,
    List<Subtest_details_list> subtestDetailsList,
  }) {
  ...
  SubtestModel.fromJson(dynamic json) {
    ...
    if (json['subtest_details_list'] != null) {
      ...
      json['subtest_details_list'].forEach((v) {
        _subtestDetailsList.add(Subtest_details_list.fromJson(v));
      });
    }
  }
  String _statusCode;
  String _message;
  List<Subtest_details_list> _subtestDetailsList;

  String get statusCode => _statusCode;
  String get message => _message;
  List<Subtest_details_list> get subtestDetailsList => _subtestDetailsList;
...
class Subtest_details_list {
  Subtest_details_list({
    String id,
    String testTypeId,
    String subtest,
    dynamic syllabus,
  ...
  Subtest_details_list.fromJson(dynamic json) {
    _id = json['id'];
